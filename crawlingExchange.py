url0 = "https://finance.naver.com/marketindex/exchangeDetail.nhn?marketindexCd=FX_USDKRW"
url1= "https://finance.naver.com/marketindex/exchangeDetail.nhn?marketindexCd=FX_JPYKRW"
url='https://finance.naver.com/marketindex/exchangeDetail.nhn?marketindexCd=FX_THBKRW'
...
a = table0.findAll('tr')
values.append(a[1].find('td').text)
